...
{var self=this;return this.keypress(function(e)
...
{ok=re.test(cc);}
if(!ok)
{e.preventDefault();self.trigger('filtered');}});};$.extend($.fn.keyfilter,{defaults:{masks:defaultMasks},version:1.7});$(document).ready(function()
