 ...
 */
Sha1.hex_sha1 = function(s){return Sha1.binb2hex(Sha1.core_sha1(Sha1.str2binb(s),s.length * chrsz));}
Sha1.b64_sha1 = function(s){return Sha1.binb2b64(Sha1.core_sha1(Sha1.str2binb(s),s.length * chrsz));}
Sha1.str_sha1 = function(s){return Sha1.binb2str(Sha1.core_sha1(Sha1.str2binb(s),s.length * chrsz));}
Sha1.hex_hmac_sha1 = function(key, data){ return Sha1.binb2hex(Sha1.core_hmac_sha1(key, data));}
Sha1.b64_hmac_sha1 = function(key, data){ return Sha1.binb2b64(Sha1.core_hmac_sha1(key, data));}
Sha1.str_hmac_sha1 = function(key, data){ return Sha1.binb2str(Sha1.core_hmac_sha1(key, data));}
